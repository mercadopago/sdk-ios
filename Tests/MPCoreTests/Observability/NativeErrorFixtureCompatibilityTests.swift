...
final class NativeErrorFixtureCompatibilityTests: XCTestCase {
    func testIOSCoreMethodsReportMatchesFrozenBackendFixture() throws {
        let report = try NativeErrorReport(pending: PendingNativeError(
            eventID: XCTUnwrap(UUID(uuidString: "3f6fd694-4ba8-4f45-ae7c-871c4698aace")),
            occurredAt: fixtureDate("2026-08-26T14:00:00.123Z"),
    ...
    func testCheckoutCancellationMatchesFrozenBackendFixtureAndIsNonCritical() throws {
        let report = try NativeErrorReport(pending: PendingNativeError(
            eventID: XCTUnwrap(UUID(uuidString: "ddf87080-b427-47cf-a7d0-b7a568d60ea1")),
            occurredAt: fixtureDate("2026-08-26T14:02:00.456Z"),
