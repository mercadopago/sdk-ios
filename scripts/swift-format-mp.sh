...
#2
swiftformat --quiet --version 0.54.2 --config $config --filelist files_to_format --exclude Pods,**/.build,**/Package.swift,vendor/bundle,scripts,fastlane,**/L10n.swift,**/Assets.swift,**/*.generated.swift,**/Generated,xcode-productivity/**/*.swift,**/Carthage/**/*.swift
formatting_result=$?
