...
private extension ReviewConfirmViewModel {
    ...
    func paymentMethodEventData(transactionAmount: Decimal) -> ReviewConfirmPaymentMethodEventData {
        ...
        case let .creditCard(paymentMethodId, paymentTypeId, _, _),
             let .debitCard(paymentMethodId, paymentTypeId, _):
            ReviewConfirmPaymentMethodEventData(
                ...
                installments: self.paymentParams.paymentMethodType.installments ?? 0
            )
        case let .ticket(paymentMethodId, paymentTypeId):
            ReviewConfirmPaymentMethodEventData(
                type: paymentTypeId,
                paymentMethodId: paymentMethodId,
                paymentTypeId: paymentTypeId,
